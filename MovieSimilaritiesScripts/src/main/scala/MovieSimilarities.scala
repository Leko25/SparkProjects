...
// spark-submit --executor-memory 1g MovieSimilarities.jar 260
...
object MovieSimilarities {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("s3://lasdotspark-practice/ml-1m/ratings.dat")
    ...
    //TODO: Partition join rdd to be used by group by key
